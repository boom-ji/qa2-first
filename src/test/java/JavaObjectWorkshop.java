...
public class JavaObjectWorkshop {
    ...
    public void workWithObjects(){
        ...
        lena.setLastName("Mandarinkova");
        lena.setAge(18);
        lena.setEmail("lapusjka@inbox.lv");


        Student raimonds = new Student("Raimponds", "Gorillins", 19, "sexyboy@gmail.com");
...
//        System.out.println(raimonds.getFullName());
        ...
        students.add(new Student("Liga", "BlaBla", 18, "liga17@gkl.com"));

        Course qa2 = new Course("QA2 - Automation", 3, students);
        qa2.addStudent(new Student("Dmitrijs", "Alibaba", 100500, "barola@gmia.lv"));
